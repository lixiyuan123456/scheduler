...
public class SqlSessionTemplate implements SqlSession {
    ...
    public static final String MAPPERS_PACKAGE_NAME = "";
    ...
    public static void main(String[] args) throws Exception {
        SqlSessionTemplate.getInstance();
    }
    ...
    private static class Singleton {
        ...
        private static SqlSessionFactory buildSqlSessionFactory() {
            ...
            if (Strings.isNullOrEmpty(MAPPERS_PACKAGE_NAME)) {
                throw new RuntimeException("mappers package has not configured yet");
            }
    ...
    private static class SqlSessionInterceptor implements InvocationHandler {
      ...
      /*try (SqlSession sqlSession = getInstance().getSqlSessionFactory().openSession(); ) {
        return method.invoke(sqlSession, args);
      } catch (Exception e) {
        throw new RuntimeException(e.getMessage(), e);
      }*/
