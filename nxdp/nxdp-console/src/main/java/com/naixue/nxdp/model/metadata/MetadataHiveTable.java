...
public class MetadataHiveTable implements Serializable {
    ...
    @Transient
    private TableEdition lastEdition;

    @Transient
    private List<TableEdition> editions = new ArrayList<>();
    ...
    @Data
    @Entity
    @Table(name = "`t_metadata_hive_table_edition`")
    public static class TableEdition {
